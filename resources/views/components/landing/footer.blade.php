<footer id="footer" class="px-5 md:px-24 xl:px-44 w-full py-10 bg-primary text-white">
    {{-- <div class="flex">
        <div class="flex flex-col gap-7">
            <h1 class="text-3xl font-main text-white tracking-widest font-extrabold whitespace-nowrap dark:text-white">
                Bakeru</h1>
            <p class="text-base font-normal text-white text-opacity-80">Di Bakeru, kami mengantarkan roti berkualitas
                dari
                pabrik roti langsung ke lokasi Anda, memastikan
                kehangatan dan kepuasan dengan setiap pesanan.</p>
        </div>
        <div class="flex flex-col">
            <ul class="flex flex-col font-regular text-base mt-7 gap-5">
                <li>
                    <a href="#"
        ...
        <div>
            ...
            <ul class="text-base font-light flex flex-col gap-4 md:gap-5 text-white text-opacity-80">
                ...
                <li><a href="#" class="hover:underline hover:underline-offset-4 inline-block">Syarat &
                        Ketentuan</a></li>
                <li><a href="#" class="hover:underline hover:underline-offset-4 inline-block">Kebijakan
                        Privasi</a></li>
            </ul>
        </div>
        <div>
