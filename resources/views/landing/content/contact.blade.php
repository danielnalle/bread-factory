    ...
    <section id="contact" class="px-5 md:px-24 xl:px-44 w-full pt-[64px] bg-[#F5F5F5]">
        <div class="flex flex-col lg:flex-row lg:justify-between gap-10 py-14">
            <div class="max-w-xl">
                ...
                <p class="text-start text-dark-secondary text-base mb-5">
                ...
                <div class="flex items-center gap-2 mb-7">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                        ...
                        <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            fill="#0C1C2E" fill-opacity="0.87" />
                    </svg>
                    <span class="text-base font-medium text-dark-primary">+62 812-3456-7890</span>
                </div>
                <div class="flex items-center gap-2 mb-7">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                            d="M11.7769 13.4647C11.1079 13.4647 10.4409 13.2437 9.88286 12.8017L5.39786 9.18574C5.07486 8.92574 5.02486 8.45274 5.28386 8.13074C5.54486 7.80974 6.01686 7.75874 6.33886 8.01774L10.8199 11.6297C11.3829 12.0757 12.1759 12.0757 12.7429 11.6257L17.1789 8.01974C17.5009 7.75674 17.9729 7.80674 18.2349 8.12874C18.4959 8.44974 18.4469 8.92174 18.1259 9.18374L13.6819 12.7957C13.1199 13.2417 12.4479 13.4647 11.7769 13.4647Z"
                            fill="#0C1C2E" fill-opacity="0.87" />
                        <mask id="mask0_269_9837" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="1" y="2"
                            width="22" height="20">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M1 2H22.4999V21.5H1V2Z" fill="white" />
                        </mask>
                        <g mask="url(#mask0_269_9837)">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <span class="text-base font-medium text-dark-primary">hello@breadfactory.id</span>
                </div>
                <div class="flex items-center gap-2 mb-7">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                            d="M12.2505 8.5C11.2855 8.5 10.5005 9.285 10.5005 10.251C10.5005 11.216 11.2855 12 12.2505 12C13.2155 12 14.0005 11.216 14.0005 10.251C14.0005 9.285 13.2155 8.5 12.2505 8.5M12.2505 13.5C10.4585 13.5 9.00049 12.043 9.00049 10.251C9.00049 8.458 10.4585 7 12.2505 7C14.0425 7 15.5005 8.458 15.5005 10.251C15.5005 12.043 14.0425 13.5 12.2505 13.5"
                            fill="#0C1C2E" fill-opacity="0.87" />
                        <mask id="mask0_269_9847" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="4" y="2"
                            width="17" height="20">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M4 2H20.4995V21.5H4V2Z" fill="white" />
                        </mask>
                        <g mask="url(#mask0_269_9847)">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                d="M12.2495 3.5C8.52751 3.5 5.49951 6.557 5.49951 10.313C5.49951 15.092 11.1235 19.748 12.2495 19.996C13.3755 19.747 18.9995 15.091 18.9995 10.313C18.9995 6.557 15.9715 3.5 12.2495 3.5V3.5ZM12.2495 21.5C10.4555 21.5 3.99951 15.948 3.99951 10.313C3.99951 5.729 7.70051 2 12.2495 2C16.7985 2 20.4995 5.729 20.4995 10.313C20.4995 15.948 14.0435 21.5 12.2495 21.5V21.5Z"
                                fill="#0C1C2E" fill-opacity="0.87" />
                        </g>
                    </svg>
                    <span class="text-base font-medium text-dark-primary">Jl. Raya Roti No.123, Denpasar, Bali 80232,
                        Indonesia</span>
                </div>
            </div>
            <div class="bg-white shadow-sm py-5 px-7 rounded-lg lg:max-w-md w-full">
                <h1 class="font-semibold mb-4 text-center lg:text-start lg:mb-0 text-2xl md:text-3xl text-dark-primary">
                    Hubungi Kami
                </h1>
                ...
                <form action="">
                    ...
                    <input type="email" id="email" name="email"
                        class=" border border-gray-300 text-dark-primary text-base rounded-lg focus:ring-primary focus:border-primary block w-full px-3 py-2.5 dark:bg-gray-700 dark:border-gray-600 placeholder-dark-tertiary dark:placeholder-gray-400 dark:text-white  dark:focus:ring-primary dark:focus:border-primary mb-5"
                    ...
                    <textarea name="desc"
                        ...
                        focus:border-primary block w-full px-3 py-2.5 mb-5 placeholder-dark-tertiary placeholder:text-base
