<form class="max-w-full mx-auto" wire:submit='store'>
    <div class="md:grid md:grid-cols-2">
        <div class="flex flex-col gap-5">
            <div>
                <label for="name" class="block mb-2.5 text-sm font-medium text-dark-primary dark:text-white">Nama
                    Metode Pembayaran<span class="text-red-600">*</span></label>
                <input type="text" id="name"
                    ...
                    placeholder="Masukan metode pembayaran" wire:model='name' />
                @error('name')
