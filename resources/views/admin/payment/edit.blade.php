    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-6">
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">Edit Metode Pembayaran</h1>
            </div>
            <div class="mb-4 sm:mb-0">
            ...
            <form class="max-w-full mx-auto">
                <div class="md:grid md:grid-cols-2">
                    <div class="flex flex-col gap-5">
                        <div>
                            <label for="name"
                                class="block mb-2.5 text-sm font-medium text-dark-primary dark:text-white">Nama Metode
                            ...
                            <input type="text" id="name"
                                ...
                                placeholder="Masukan metode pembayaran" value="BCA (Bank Central Asia)" required />
                        </div>
