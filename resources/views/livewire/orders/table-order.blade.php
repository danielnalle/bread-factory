    ...
    <div class="overflow-x-auto">
        <div class="flex space-x-5 text-sm font-medium border-b mb-5">
            <button type="button" wire:click="filter('')"
                class="relative py-2 text-dark-tertiary @if ($selectedOrderStatus == '') {{ 'text-primary' }} @endif  hover:text-primary group">
                Semua
                <span
            ...
            @foreach ($order_status as $status)
                <button type="button"
                    class="relative py-2 @if ($selectedOrderStatus == $status->id) {{ 'text-primary' }} @endif text-dark-tertiary hover:text-primary group"
                    wire:click="filter({{ $status->id }})">
                    {{ $status->name }}
                    <span
            ...
            <div class="mb-4 sm:mb-0">
                ...
                <div class="relative mt-1">
                    ...
                    <input type="text" id="table-search"
                        ...
                        placeholder="Cari pesanan berdasarkan nama dan no pesanan" wire:model.live='search'>
                </div>
            </div>
        </div>
                ...
                @foreach ($orders as $order)
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="flex items-center px-6 py-4">
                            <a href="{{ route('orders.detail', $order->no_order) }}"
                            ...
                            @if (auth()->user()->role == 'admin')
                                <button type="button" wire:click="deleteConfirm({{ $order->cart_id }})"
                                        ...
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700"
                                            ...
                                            <div class="p-4 md:p-5 text-center">
                                                ...
                                                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                                                    Kamu
                                                    yakin ingin menghapus pesanan ini?</h3>
                                                <button type="button"
