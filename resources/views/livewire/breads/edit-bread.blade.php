            ...
            <div class="bg-white p-5 rounded-lg shadow-sm">
                <div class="mb-5">
                    ...
                    <input type="text" id="name"
                        ...
                        placeholder="Masukan nama roti" wire:model="name" />
                    @error('name')
                ...
                <div>
                    ...
                    <textarea name="desc"
                        ...
                        id="desc" rows="6" maxlength="600" placeholder="Masukan deskripsi roti" wire:model='description'></textarea>
                    @error('description')
                        <span class="text-red-600 text-sm">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="bg-white p-5 rounded-lg shadow-sm">
                <div class="mb-5">
                    ...
                    <input type="number" id="kuantitas"
                        ...
                        placeholder="Masukan kuantitas roti" wire:model='quantity' />
                    @error('quantity')
                        <span class="text-red-600 text-sm">{{ $message }}</span>
                    @enderror
                </div>
                <div class="mb-5">
                    ...
                    <input type="number" id="harga"
                        class=" border border-gray-300 text-dark-primary text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-3 placeholder-dark-secondary dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary dark:focus:border-primary"
                        placeholder="Masukan harga roti" wire:model='price' />
                    @error('price')
                        <span class="text-red-600 text-sm">{{ $message }}</span>
                    @enderror
                </div>
