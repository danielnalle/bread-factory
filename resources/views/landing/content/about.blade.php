<x-guest-layout>
    <section id="heroSection" class="px-5 md:px-10 w-full h-screen pt-[104px] pb-10">
        <div style="background-image: url('/images/about-bg.webp');"
            class="bg-cover bg-center h-full rounded-lg overflow-hidden">
            <div class="flex items-center md:items-end p-4 bg-black bg-opacity-20 justify-start h-full">
                <div class="bg-white rounded-lg p-7">
                    <div class="max-w-xl flex flex-col items-center md:items-start">
                        <button disabled
                            class="text-dark-primary border tracking-tight border-dark-secondary text-sm sm:text-base font-medium shadow-sm rounded-full px-4 py-2 text-center mb-4">
                            Tentang Bakeru
                        </button>
                        <h1
                            class="text-4xl text-dark-primary text-center md:text-start sm:text-5xl md:text-[56px] font-main font-medium mb-4 leading-tight md:leading-none">
                            Membawa Kesegaran
                            <span class="inline-block md:mt-2">Dan Kualitas Di Setiap</span>
                            <span class="inline-block md:mt-2">Gigitan!</span>
                        </h1>
                        <p class="text-center mb-5 text-dark-secondary md:text-start text-sm sm:text-base font-normal">
    ...
    <section id="overview" class="px-5 md:px-24 xl:px-44 w-full py-8 sm:py-14">
        <div class="max-w-5xl flex flex-col items-center gap-8 mx-auto mb-9">
            ...
            <p class="text-center text-dark-secondary text-sm sm:text-base font-medium">
    ...
    <section id="ourTim" class="px-5 md:px-24 xl:px-44 w-full pt-5 pb-14 sm:pb-24">
